...
from day01.calibrate import calibrate


class TestCalibrate(unittest.TestCase):
    def test_exists(self):
        self.assertEqual(0, calibrate(""))  # add assertion here

    def test_one_digit(self):
        self.assertEqual(33, calibrate("3"))

    def test_one_digit_with_letters(self):
        self.assertEqual(55, calibrate("lw5kwf"))

    def test_two_digits(self):
        self.assertEqual(97, calibrate("aln9flkrng7lag"))

    def test_three_digits(self):
        self.assertEqual(93, calibrate("aln9flk15rng3lag"))
...
input = """ckmb52fldxkseven3fkjgcbzmnr7
